...
if authentication_status:
    ...
    def submit_result():
        if len(st.session_state["starting_options"])<st.session_state["options_max"] and st.session_state["input_text"] not in st.session_state["starting_options"]:
            st.session_state["current_options"].append(st.session_state["input_text"])
    ...
    if "current_options" not in st.session_state:
        st.session_state["current_options"] = st.session_state["starting_options"]
    ...
    if topic == "Check contract":
        with st.container():
            ...
            st.session_state["current_options"] = st.multiselect(
                '',
